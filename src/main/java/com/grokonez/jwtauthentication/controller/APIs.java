...
import com.grokonez.jwtauthentication.security.services.CropService;
import com.grokonez.jwtauthentication.utils.Response;
...
public class APIs {
	...
	public Response getAllCrops(){
		return new Response(cropService.getAllCrops());
	}
}